...
class CfgWorlds
{
	...
	class TutorialIsland: CAWorld
	{
		...
		icon = "";
		worldName = "\TutorialIsland\TutorialIsland.wrp";
		...
		newRoadsShape = "\TutorialIsland\data\roads\roads.shp";
