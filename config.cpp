...
class CfgPatches
{
	class 15meu_Arujo //Look it up here: https://sites.google.com/site/islandconfigs/home
	{
		units[] = {}; //removed name, the caps video doesn't have this. //{"15meu_Arujo"}; //not sure if it must be filled, as Stratis didn't, but A2 Maps did...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3_Data_F","A3_Roads_F","A3_Structures_F","A3_Map_Data","jbad_Structures"};
		author = "SSgt Buchanan, 1stLt Delgado, SSgt Carrido"; //Author Name (this entry exists twice!)
...
class CfgWorlds
{
	//this were in the caps video, and probably need to be set.
	mapSize = 20480;
	mapZone = 35;
	...
	class DefaultWorld
	{
		//cutscenes is not in the caps example
	...
	class 15meu_Arujo: CAWorld
	{
		...
		worldId = 1919; //unknown, change to any number you like
		cutscenes[] = {""}; //plays in main menu
		description = "Arujo"; //Shown as name when choosing Island
		icon = ""; //Icon in front of Island Name
		worldName = "\Custom\Terrain\CustomTest.wrp"; //path to your WRP file
		...
		author = "15th MEU (SOC) Realism Unit"; //Author
		mapSize = 20480; //probably the same number as your terrain image size
		mapZone = 35; //unknown
		...
		newRoadsShape = "\Custom\Terrain\data\roads\roads.shp"; //roads file!
		...
		loadingTexts[] = {"Loading text test.", "Arujo is a beautiful country" , "Please visit Arujo. Pls."}; //Loading Texts
	};
};
class CfgWorldList//??
{
